...
def process_test_data():
    ...
    cars_annos = scipy.io.loadmat(r'./devkit/cars_test_annos')
    annotations = cars_annos['annotations']
    annotations = np.transpose(annotations)
...
if __name__ == '__main__':
    ...
    ensure_folder(r'./data/train')
    ensure_folder(r'./data/valid')
    ensure_folder(r'./data/test')

    process_train_data()
    process_test_data()

    # clean up
    shutil.rmtree(r'./cars_train')
    shutil.rmtree(r'./cars_test')
