...
CUDA_DEVICES = 0
DATASET_ROOT = 'C:/Users/IDEA3C/Dropbox/Machinelearning/question/ML-HW1/seg_train'
...
def train():
	...
	data_loader = DataLoader(dataset=train_set, batch_size=8, shuffle=True, num_workers=1)
